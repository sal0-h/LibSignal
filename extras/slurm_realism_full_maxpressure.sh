#!/usr/bin/env bash
#SBATCH --job-name=mp_realism_full_4x4
#SBATCH --output=logs/maxpressure_realism_full_4x4_%j.out
#SBATCH --error=logs/maxpressure_realism_full_4x4_%j.err
...
echo "Host: $(hostname)"
echo "Agent: maxpressure_realism_full  Network: sumo4x4  Seed: 42"
