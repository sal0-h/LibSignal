#!/usr/bin/env bash
#SBATCH --job-name=dqn_cross_proxy_4x4
#SBATCH --output=logs/dqn_crossing_proxy_4x4_%j.out
#SBATCH --error=logs/dqn_crossing_proxy_4x4_%j.err
...
echo "Host: $(hostname)"
echo "Agent: dqn_crossing_proxy  Network: sumo4x4  Seed: 42"
