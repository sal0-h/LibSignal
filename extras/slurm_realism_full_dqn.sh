#!/usr/bin/env bash
#SBATCH --job-name=dqn_realism_full_4x4
#SBATCH --output=logs/dqn_realism_full_4x4_%j.out
#SBATCH --error=logs/dqn_realism_full_4x4_%j.err
...
echo "Host: $(hostname)"
echo "Agent: dqn_realism_full  Network: sumo4x4  Seed: 42"
