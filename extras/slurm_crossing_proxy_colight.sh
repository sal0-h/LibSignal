#!/usr/bin/env bash
#SBATCH --job-name=colight_cross_proxy_4x4
#SBATCH --output=logs/colight_crossing_proxy_4x4_%j.out
#SBATCH --error=logs/colight_crossing_proxy_4x4_%j.err
...
echo "Host: $(hostname)"
echo "Agent: colight_crossing_proxy  Network: sumo4x4  Seed: 42"
