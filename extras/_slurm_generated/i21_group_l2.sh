#!/usr/bin/env bash
#SBATCH --job-name=i21_l2
#SBATCH --output=logs/i21_group_l2_%j.out
#SBATCH --error=logs/i21_group_l2_%j.err
...
echo "Host: $(hostname)"
echo "Group: l2  Network: ${NETWORK}  Seed: ${SEED}"
echo "Start: $(date -Is)"
...
run_one fixedtime_odh_l2_1x21 odh_l2_1x21_es
run_one maxpressure_odh_l2_1x21 odh_l2_1x21_es
run_one dqn_odh_l2_1x21 odh_l2_1x21_es
run_one presslight_odh_l2_1x21 odh_l2_1x21_es
run_one colight_odh_l2_1x21 odh_l2_1x21_es

echo "Group l2 finished: $(date -Is)"
