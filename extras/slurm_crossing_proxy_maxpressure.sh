#!/usr/bin/env bash
#SBATCH --job-name=mp_cross_proxy_4x4
#SBATCH --output=logs/maxpressure_crossing_proxy_4x4_%j.out
#SBATCH --error=logs/maxpressure_crossing_proxy_4x4_%j.err
...
echo "Host: $(hostname)"
echo "Agent: maxpressure_crossing_proxy  Network: sumo4x4  Seed: 42"
