#!/usr/bin/env python3
"""
Hub-centric synthetic OD demand generator for grid4x4 (1800 s).
...
timeline). Uses SUMO od2trips + duarouter to emit a demand set:
  ...
  data/raw_data/grid4x4/od_hubs/demand_set/
    fixed_1800.rou.xml
...
TAZ = REPO / "data/raw_data/grid4x4/od_hubs/taz.xml"
OUT_DIR = REPO / "data/raw_data/grid4x4/od_hubs/demand_set"
REL_PREFIX = "raw_data/grid4x4/od_hubs/demand_set"
...
def main():
    ...
    manifest = {
        ...
        "taz": "raw_data/grid4x4/od_hubs/taz.xml",
        ...
        "note": (
            "Hub-centric synthetic OD; mixed fringe/internal origins; "
            "1800s shoulder+peak; demand set + held-out protocol."
        ),
    }
