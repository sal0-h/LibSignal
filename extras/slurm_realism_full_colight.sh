#!/usr/bin/env bash
#SBATCH --job-name=cl_realism_full_4x4
#SBATCH --output=logs/colight_realism_full_4x4_%j.out
#SBATCH --error=logs/colight_realism_full_4x4_%j.err
...
echo "Host: $(hostname)"
echo "Agent: colight_realism_full  Network: sumo4x4  Seed: 42"
