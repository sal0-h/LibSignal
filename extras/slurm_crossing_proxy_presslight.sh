#!/usr/bin/env bash
#SBATCH --job-name=pl_cross_proxy_4x4
#SBATCH --output=logs/presslight_crossing_proxy_4x4_%j.out
#SBATCH --error=logs/presslight_crossing_proxy_4x4_%j.err
...
echo "Host: $(hostname)"
echo "Agent: presslight_crossing_proxy  Network: sumo4x4  Seed: 42"
