...
| [INPUT_STATE_DESIGN.md](INPUT_STATE_DESIGN.md) | Explicit rich-input variants of DQN, PressLight, and CoLight: features, sensor semantics, configs, and bounded smoke checks. |
